...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('oscar_docdata_docdatapayment', 'confidence_level',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'DocdataPayment.amount_allocated'
        db.add_column('oscar_docdata_docdatapayment', 'amount_allocated',
        ...
        db.add_column('oscar_docdata_docdatapayment', 'amount_debited',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataPayment.amount_refunded'
        db.add_column('oscar_docdata_docdatapayment', 'amount_refunded',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataPayment.amount_chargeback'
        db.add_column('oscar_docdata_docdatapayment', 'amount_chargeback',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataOrder.total_registered'
        db.add_column('oscar_docdata_docdataorder', 'total_registered',
        ...
        db.add_column('oscar_docdata_docdataorder', 'total_shopper_pending',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataOrder.total_acquirer_pending'
        db.add_column('oscar_docdata_docdataorder', 'total_acquirer_pending',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataOrder.total_acquirer_approved'
        db.add_column('oscar_docdata_docdataorder', 'total_acquirer_approved',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataOrder.total_captured'
        db.add_column('oscar_docdata_docdataorder', 'total_captured',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataOrder.total_refunded'
        db.add_column('oscar_docdata_docdataorder', 'total_refunded',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'DocdataOrder.total_charged_back'
        db.add_column('oscar_docdata_docdataorder', 'total_charged_back',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('oscar_docdata_docdatapayment', 'confidence_level')

        # Deleting field 'DocdataPayment.amount_allocated'
        db.delete_column('oscar_docdata_docdatapayment', 'amount_allocated')

        # Deleting field 'DocdataPayment.amount_debited'
        db.delete_column('oscar_docdata_docdatapayment', 'amount_debited')

        # Deleting field 'DocdataPayment.amount_refunded'
        db.delete_column('oscar_docdata_docdatapayment', 'amount_refunded')

        # Deleting field 'DocdataPayment.amount_chargeback'
        db.delete_column('oscar_docdata_docdatapayment', 'amount_chargeback')

        # Deleting field 'DocdataOrder.total_registered'
        db.delete_column('oscar_docdata_docdataorder', 'total_registered')

        # Deleting field 'DocdataOrder.total_shopper_pending'
        db.delete_column('oscar_docdata_docdataorder', 'total_shopper_pending')

        # Deleting field 'DocdataOrder.total_acquirer_pending'
        db.delete_column('oscar_docdata_docdataorder', 'total_acquirer_pending')

        # Deleting field 'DocdataOrder.total_acquirer_approved'
        db.delete_column('oscar_docdata_docdataorder', 'total_acquirer_approved')

        # Deleting field 'DocdataOrder.total_captured'
        db.delete_column('oscar_docdata_docdataorder', 'total_captured')

        # Deleting field 'DocdataOrder.total_refunded'
        db.delete_column('oscar_docdata_docdataorder', 'total_refunded')

        # Deleting field 'DocdataOrder.total_charged_back'
        db.delete_column('oscar_docdata_docdataorder', 'total_charged_back')
