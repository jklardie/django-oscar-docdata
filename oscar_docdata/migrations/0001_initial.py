...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('oscar_docdata_docdataorder', (
        ...
        db.send_create_signal('oscar_docdata', ['DocdataOrder'])

        # Adding model 'DocdataPayment'
        db.create_table('oscar_docdata_docdatapayment', (
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_oscar_docdata.docdatapayment_set', null=True, to=orm['contenttypes.ContentType'])),
        ...
        db.send_create_signal('oscar_docdata', ['DocdataPayment'])

        # Adding model 'DocdataDirectDebitPayment'
        db.create_table('oscar_docdata_docdatadirectdebitpayment', (
            ('docdatapayment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['oscar_docdata.DocdataPayment'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('oscar_docdata', ['DocdataDirectDebitPayment'])


    def backwards(self, orm):
        # Deleting model 'DocdataOrder'
        db.delete_table('oscar_docdata_docdataorder')

        # Deleting model 'DocdataPayment'
        db.delete_table('oscar_docdata_docdatapayment')

        # Deleting model 'DocdataDirectDebitPayment'
        db.delete_table('oscar_docdata_docdatadirectdebitpayment')
